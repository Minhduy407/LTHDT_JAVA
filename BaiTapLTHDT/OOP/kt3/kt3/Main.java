...
public class Main {
	public static void main(String[] args) {
		...
		dssv.themSinhVien(new SinhVien("11111113", "Lê", "lan","Nữ", LocalDate.now(), "DHKTPM18B", 9.5f, HeDaoTao.CHINH_QUY));
		dssv.themSinhVien(new SinhVien("11111114", "Lê", "Hồng","Nữ", LocalDate.now(), "DHKTPM18B", 9.5f, HeDaoTao.CHINH_QUY));
