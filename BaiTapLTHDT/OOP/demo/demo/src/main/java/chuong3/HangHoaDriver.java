...
public class HangHoaDriver {
	...
	public static void main(String[] args) {
		...
		try {
			ds.them(new HangDienMay("01", "Tủ lạnh 123lít", 5000000, 1000, 12,
					2000));
			ds.them(new HangDienMay("02", "Bếp điện từ Sunhouse", 600000, 0,
					12, 2100));
			ds.them(new HangDienMay("03", "Bếp hồng ngoại", 550000, 0, 24,
					2000));
			ds.them(new HangSanhSu("04", "Chén bông Đào", 15000, 0,
					"Minh Long 1", LocalDate.of(2018, 10, 5)));
			ds.them(new HangSanhSu("05", "Tô bông Đào", 18000, 0,
					"Minh Long 1", LocalDate.of(2018, 01, 24)));
			ds.them(new HangThucPham("06", "Gạo nàng thơm", 17000, 0,
			...
			do {
				...
				case 1:
					...
					break;
				case 2:
					Arrays.stream(ds.getDshh()).forEach(System.out::println);
					break;
				case 3:
					break;
				case 4:
				...
				case 8:
					break;
				case 9:
					int dem = ds.xoaHangTon0();
					System.out.println("Đã xóa " + dem + " hàng hóa");
					break;
				case 10:
