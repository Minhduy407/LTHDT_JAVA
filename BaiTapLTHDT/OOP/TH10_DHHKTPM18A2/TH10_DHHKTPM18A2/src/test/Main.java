...
import list.DanhSachCaNhan;

public class Main {
	public static void main(String[] args) {
		
//		2a
		DanhSachCaNhan dsCaNhan = new DanhSachCaNhan();
...
//		2b/
		...
		dsCaNhan.getDsCaNhan().forEach(x -> System.out.println(x));
...
//		2d
		...
		dsCaNhan.getBenhNhanLaTreCon().forEach(x -> System.out.println(x));
